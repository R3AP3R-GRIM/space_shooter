...
void introScreen()
{
	...
	glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0, "Thapar Institute of Engineering and Technology");
	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-300, 385, 0.0, "Computer Science and Engineering");
	glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-225, 300, 0.0, "Project: Space_Shooterz");
	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-125, 225, 0.0, "Space_Shooterz");
	glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-80, 150, 0.0, "created by");
	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0, " Lakshay Bhatti: 3CS3 : 102017057");
	displayRasterText(-800, -285, 0.0, " Tanveer Singh : 3CS3 : 102017066");
	glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0, "Submitted To:");
	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0, "Ms. Jasmine Kaur");
	glColor3f(1.0, 0.0, 0.0);
...
void instructionsScreenDisplay()
{
	...
	glColor3f(1, 0, 0);
	displayRasterText(-1000, 400, 0.4, "Lakshay");
	displayRasterText(200, 400, 0.4, "Tanveer");
	glColor3f(1, 1, 1);
